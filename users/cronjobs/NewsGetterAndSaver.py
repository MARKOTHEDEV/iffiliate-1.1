    ...
    def get_data(self):
        ...
        if bs != False:
            ...
            for link in ListOfPostLinks:
                ...
                newPage = self.get_page_obj(link['href'])
                if newPage != False:
...
# html = urlopen('https://www.vanguardngr.com/category/national-news/')

# bs = BeautifulSoup(html,'html.parser')


# newsContainer = bs.select('span.rtp-latest-news-title a')

# count =0
# for links in newsContainer:
#     print(links['href'])
#     count +=1
