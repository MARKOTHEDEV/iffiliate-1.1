...
from users.models import MoneyPost
def create():
    MoneyPost.objects.create(
        title="a",content="a",image_link = "fjkdf"
    )
...
def start():
    ...
    scheduler.add_job(create,"interval",minutes=1,id="get_money_post_002",replace_existing=True)
